<template>
    ...
    <div>
        ...
        <!-- Encabezado para la segunda tabla -->
        <h3 class="text-2xl font-bold text-gray-800 mt-6 mb-4">Titulación:  {{ selectedCarreraName }}</h3>
        <!-- Aquí muestra la tabla secundaria si la variable showSecondTable es verdadera -->
...
const extracionHeaders = () => {
    // const dataTmp: Object = props.data[0]
    // console.log(Object.keys(dataTmp))
    // console.log(Object.values(dataTmp))
...
//     CAR_ACTIVA_ESCUELA: 'CAR_ACTIVA_ESCUELA'
// };

// Filtrar usuarios
// const filteredUsers = computed(() => {
//     return props.data.filter(user => user.CAR_CARRERA === 1);
// });
